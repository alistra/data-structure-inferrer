...
\section{Introduction} \label{sec:intro}
	...
	\subsection{C API}
        ...
        have a balanced search tree that guarantees $O(log n)$ lookups, with a linked list of all the elements \todo{ref
        gen mods} to enhance the speed of the successor and predecessor operations to $O(1)$. If we wanted to create a
...
\section{Extensions of the idea}
	...
	\subsection{Importance of operations} \label{sub:importance}
		...
		\subsubsection{Choosing the best data structure with weights} \label{sec:choose-weights}
            ...
            We change the definition of \autoref{data-structure-order} to \todo{weights}:
            ...
            \begin{equation} \label{data-structure-order-weights}
                \displaystyle \sum^n_n \{w_1 - w_2| (o, c_1, w_1) \in d_1, o \in ds, (o,c_2, w_2) \in d_2, c_1 < c_2 \} > 0
            \end{equation}
...
\begin{thebibliography}{9}
	\bibitem{Wi} Wikipedia - http://en.wikipedia.org/
