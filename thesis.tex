...
\section{Implementation}
	...
	\subsection{Generic data structure modifications} \label{sub:gdsm}
		...
		\subsubsection{Extremal element cache}
			...
			We notice that a lot of data structures already implement this pattern \todo{which ones, veb?}.
...
\section{Future work} \label{sec:future}
	...
	removing unnecessary calls to data structure operations, so the framework can infer the data structure based on
